...
function _signUp() {
  _signUp = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(formData) {
    var res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _axios.default.post("/api/v1/users/signup", _objectSpread({}, formData));
        case 1:
          res = _context.v;
          if (res.data.status) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          (0, _alert.showAlert)("error", "Erorr trying to log out. Try again !!");
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var session, _err$response, _err$response2, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
        ...
        case 2:
          ...
          _t = _context.v;
          console.log(_t);
          (0, _alert.showAlert)('error', "".concat((_err$response = _t.response) === null || _err$response === void 0 ? void 0 : _err$response.status, ": ").concat((_err$response2 = _t.response) === null || _err$response2 === void 0 ? void 0 : _err$response2.statusText));
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          url = type === "data" ? "submit-user-data" : "/api/v1/users/updateMyPassword";
          _context.n = 1;
          return _axios.default.patch(url, data);
        case 1:
          res = _context.v;
          if (res.statusText === "OK") (0, _alert.showAlert)("success", "".concat(type.toUpperCase(), " was updated successfully"));
          _context.n = 4;
          break;
        case 2:
          _context.p = 2;
          ...
          return _context.a(2, (0, _alert.showAlert)("error", _t.message));
        case 3:
          (0, _alert.showAlert)("error", _t.response.data.message);
        case 4:
          return _context.a(2);
...
if (logoutButton) logoutButton.addEventListener("click", _logout.logout);
...
if (formSignUp) formSignUp.addEventListener("submit", function (e) {
  e.preventDefault();
  var name = document.querySelector(".n_signup").value;
  var email = document.querySelector(".e_signup").value;
  var password = document.querySelector(".p_signup").value;
  var passwordConfirm = document.querySelector(".c_signup").value;
  (0, _signup.signUp)({
    name: name,
    email: email,
    password: password,
